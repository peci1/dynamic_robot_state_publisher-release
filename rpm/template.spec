Name:           ros-melodic-dynamic-robot-state-publisher
Version:        1.1.1
Release:        0%{?dist}
Summary:        ROS dynamic_robot_state_publisher package
...
%description
Improved ROS robot_state_publisher which can update the robot model via
dynamic_reconfigure.
...
%changelog
* Tue Mar 05 2019 Martin Pecka <peckama2@fel.cvut.cz> - 1.1.1-0
